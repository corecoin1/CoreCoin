...
int64_t GetProofOfWorkReward(int64_t nFees)
{
	...
	{
		// 선채굴
		nSubsidy = 8000000000 * COIN;
	}
	else if (pindexBest->nHeight+1 > 1 && pindexBest->nHeight+1 <= 100)
	{
		// 
		nSubsidy = 0 * COIN;
	}
	...
	{
		// 선채굴 이후
		nSubsidy = (10.0 - (((int)((pindexBest->nHeight+1)/21600))*0.02)) * COIN;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "06/24/2016 @ 5:28am (UTC)";
        CTransaction txNew;
        // coinvest, 최초 시작 시간
        txNew.nTime = 1466746087;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        // coinvest, 최초 시작 시간
        block.nTime    = 1466746087;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        // coinvest, nNonce
        block.nNonce   = 5887697;
		if(fTestNet)
        {
        ...
        //// debug print
        // coinvest, MerkleRoot
        assert(block.hashMerkleRoot == uint256("0x3a0d0cdc742e14d3eb1cf95884fdcb6c7169acf474ea0d8e417720f095d7a004"));
        block.print();
